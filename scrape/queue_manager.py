...
def init_db(db_path: str = "scrape/queue.db"):
...
def get_pending_tasks(db_path: str = "scrape/queue.db", limit: int = 50):
...
def mark_task_status(quarter: str, year: int, major: str, status: str, db_path: str = "scrape/queue.db"):
