...
function peg$parse(input, options) {
  ...
  const peg$c3 = "(";
  const peg$c4 = ")";
  const peg$c5 = "instructor";
  const peg$c6 = "prof";
  const peg$c7 = "building";
  const peg$c8 = "room";
  const peg$c9 = "sln";
  const peg$c10 = "title";
  const peg$c11 = "course";
  const peg$c12 = "gened";
  const peg$c13 = ":";
  const peg$c14 = "\"";
  ...
  const peg$e5 = peg$literalExpectation("instructor", true);
  const peg$e6 = peg$literalExpectation("prof", true);
  const peg$e7 = peg$literalExpectation("building", true);
  const peg$e8 = peg$literalExpectation("room", true);
  const peg$e9 = peg$literalExpectation("sln", true);
  const peg$e10 = peg$literalExpectation("title", true);
  const peg$e11 = peg$literalExpectation("course", true);
  const peg$e12 = peg$literalExpectation("gened", true);
  ...
  function peg$f4(expr) {    return { type: "NOT", value: expr };  }
  ...
  function peg$f7(chars) {    return { type: "EXACT", value: chars.join("") };  }
  function peg$f8(chars) {    
         return { type: "WORD", value: chars.join("").trim() }; 
  }
  function peg$f9(char) {    
         return char; 
  }
  ...
  function peg$parseAndExpression() {
    ...
    s0 = peg$currPos;
    s1 = peg$parseImplicitAndExpression();
    if (s1 !== peg$FAILED) {
      s2 = [];
      s3 = peg$currPos;
      s4 = peg$parse_();
      ...
      if (s5 !== peg$FAILED) {
        s6 = peg$parse_();
        s7 = peg$parseImplicitAndExpression();
        if (s7 !== peg$FAILED) {
          s4 = [s4, s5, s6, s7];
          s3 = s4;
        } else {
    ...
    if (s0 === peg$FAILED) {
      s0 = peg$parseImplicitAndExpression();
    }
  ...
  function peg$parseImplicitAndExpression() {
  ...
  function peg$parsePrimary() {
    ...
    if (s0 === peg$FAILED) {
      ...
      if (s0 === peg$FAILED) {
        s0 = peg$parseSpecifier();
        if (s0 === peg$FAILED) {
          s0 = peg$parseExactMatch();
          if (s0 === peg$FAILED) {
            s0 = peg$parseTextChunk();
          }
        }
      }
    }
  ...
  function peg$parseValidSpecifierKey() {
    let s0;
  ...
  function peg$parseSpecifier() {
    ...
    if (s1 !== peg$FAILED) {
      ...
      if (s2 !== peg$FAILED) {
        s3 = peg$parseExactMatch();
        if (s3 === peg$FAILED) {
          s3 = peg$parseTextChunkNoSpace();
        }
        if (s3 !== peg$FAILED) {
          peg$savedPos = s0;
          s0 = peg$f6(s1, s3);
  ...
  function peg$parseChunkChar() {
    ...
    if (s2 === peg$FAILED) {
      ...
      if (s2 === peg$FAILED) {
        ...
        if (s2 === peg$FAILED) {
          s2 = peg$parseSpecifierLookahead();
        }
      }
    }
    peg$silentFails--;
  ...
  function peg$parseSpecifierLookahead() {
    let s0, s1, s2;
  ...
  function peg$parseTextChunkNoSpace() {
    let s0, s1, s2;
